  ...
  return (
    <div name='home' className="w-full h-screen bg-[#83A1CD]">
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        <p className='text-[#3A3A5D]'>Hey, my name is</p>
        ...
        <div>
          <button className='text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-[#3A3A5D] hover:border-[#3A3A5D]'>View Work
